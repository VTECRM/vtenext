...
if (!$skip){
	...
	//$adb->startTransaction(); // crmv@168337
	$records=do_import_users(date("Y-m-d H:i:s",$time_start),$working_id,$adbext);
	//$adb->completeTransaction(); // crmv@168337
	$time_end = time();
