 ...
 ************************************/
function do_import_products($time_start,$import_id=false,$dbobject = null) {
	...
	if ($process){
		$import = new importer($module,$mapping,$external_code,$time_start,$fields_auto_create,$fields_auto_update,$import_id,$table,$import_id,$fields_jump_update); // crmv@186024
