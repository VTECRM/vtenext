...
class Imap
{
    ...
    public function readResponse($tag, $dontParse = false)
    {
        ...
        if (is_object($this->crmMessage)) $this->crmMessage->logIMAP('READ', $tokens[0]);	//crmv@76756 crmv@83550
    ...
    public function sendRequest($command, $tokens = array(), &$tag = null)
    {
        ...
        if (is_object($this->crmMessage)) $this->crmMessage->logIMAP('SEND', $line);	//crmv@76756 crmv@83550
