		...
		<tr>
			...
			<td class="showPanelBg" style="padding: 5px;" valign="top" width="100%"> <!-- crmv@30683 -->
				{if $SMSCONFIG_MODE neq 'edit'}	
					<form action="index.php" method="post" name="SmsServer" id="form" onsubmit="VteJS_DialogBox.block();">
					<input type="hidden" name="smsconfig_mode">
				{else}
					{literal}
					<form action="index.php" method="post" name="SmsServer" id="form" onsubmit="if (VTE.Settings.SmsConfig.validate_sms_server(SmsServer)) { VteJS_DialogBox.block(); return true; } else { return false; }">
					{/literal}
