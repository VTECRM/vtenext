...
{if $sdk_mode eq 'detail'}
	{if $keyreadonly eq 99}
		<td width=25% class="dvtCellInfo" align="left">
			...
			<img src="modules/SDK/examples/uitypeSocial/img/qzico.png" align="left" alt="QZone" title="QZone" />
			{if $keyval neq ''}
			  <a target="_blank" href="http://{$keyval}.qzone.qq.com">http://{$keyval}.qzone.qq.com</a>
			{/if}
			</span>
		</td>
	{else}
...
{elseif $sdk_mode eq 'edit'}
	{if $readonly eq 99}
		...
		<td width=30% align=left class="dvtCellInfo">
		    <img src="modules/SDK/examples/uitypeSocial/img/qzico.png" align="left" alt="QZone" title="QZone" /><span>&nbsp;http://&nbsp;</span>
			<input type="hidden" name="{$fldname}" tabindex="{$vt_tab}" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox >
			{$fldvalue}
			<span>&nbsp;.qzone.qq.com</span>
		</td>
	...
	{else}
		...
		<td width=30% align=left class="dvtCellInfo">
			<img src="modules/SDK/examples/uitypeSocial/img/qzico.png" align="left" alt="QZone" title="QZone" /><span>&nbsp;http://&nbsp;</span>
			<input style="width:50%;" type="text" name="{$fldname}" tabindex="{$vt_tab}" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			<span>&nbsp;.qzone.qq.com</span>
		</td>
	{/if}
{/if}