...
{if $sdk_mode eq 'detail'}
	{if $keyreadonly eq 99}
		<td width=25% class="dvtCellInfo" align="left">
			...
			<img src="modules/SDK/examples/uitypeSocial/img/gpico.png" align="left" alt="Google+" title="Google+" />
			{if $keyval neq ''}
			  <a target="_blank" href="https://plus.google.com/u/0/{$keyval}">https://plus.google.com/u/0/{$keyval}</a>
			{/if}
			</span>
		</td>
	{else}
...
{elseif $sdk_mode eq 'edit'}
	{if $readonly eq 99}
		...
		<td width=30% align=left class="dvtCellInfo">
		    <img src="modules/SDK/examples/uitypeSocial/img/gpico.png" align="left" alt="Google+" title="Google+" /><span>&nbsp;https://plus.google.com/u/0/&nbsp;</span>
	...
	{else}
		...
		<td width=30% align=left class="dvtCellInfo">
			<img src="modules/SDK/examples/uitypeSocial/img/gpico.png" align="left" alt="Google+" title="Google+" /><span>&nbsp;https://plus.google.com/u/0/&nbsp;</span>
			<input style="width:46%;" type="text" name="{$fldname}" tabindex="{$vt_tab}" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
		</td>
	{/if}
{/if}