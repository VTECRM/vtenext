...
{if $sdk_mode eq 'detail'}
	{if $keyreadonly eq 99}
		<td width=25% class="dvtCellInfo" align="left">
			...
			<img src="modules/SDK/examples/uitypeSocial/img/fbico.png" align="left" alt="Facebook" title="Facebook" />
			{if $keyval neq ''}
			  <a target="_blank" href="http://www.facebook.com/{$keyval}">http://www.facebook.com/{$keyval}</a>
			{/if}
			</span>
		</td>
	{else}
...
{elseif $sdk_mode eq 'edit'}
	{if $readonly eq 99}
		...
		<td width=30% align=left class="dvtCellInfo">
		    <img src="modules/SDK/examples/uitypeSocial/img/fbico.png" align="left" alt="Facebook" title="Facebook" /><span>&nbsp;http://www.facebook.com/&nbsp;</span>
	...
	{else}
		...
		<td width=30% align=left class="dvtCellInfo">
			<img src="modules/SDK/examples/uitypeSocial/img/fbico.png" align="left" alt="Facebook" title="Facebook" /><span>&nbsp;http://www.facebook.com/&nbsp;</span>
			<input style="width:49%;" type="text" name="{$fldname}" tabindex="{$vt_tab}" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
		</td>
	{/if}
{/if}