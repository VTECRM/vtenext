...
{if $sdk_mode eq 'detail'}
	{if $keyreadonly eq 99}
		<td width=25% class="dvtCellInfo" align="left">
			...
			<img src="modules/SDK/examples/uitypeSocial/img/twico.png" align="left" alt="Twitter" title="Twitter" />
			{if $keyval neq ''}
			  <a target="_blank" href="http://twitter.com/{$keyval}">http://twitter.com/{$keyval}</a>
			{/if}
			</span>
		</td>
	{else}
...
{elseif $sdk_mode eq 'edit'}
	{if $readonly eq 99}
		...
		<td width=30% align=left class="dvtCellInfo">
		    <img src="modules/SDK/examples/uitypeSocial/img/twico.png" align="left" alt="Twitter" title="Twitter" /><span>&nbsp;http://twitter.com/&nbsp;</span>
	...
	{else}
		...
		<td width=30% align=left class="dvtCellInfo">
			<img src="modules/SDK/examples/uitypeSocial/img/twico.png" align="left" alt="Twitter" title="Twitter" /><span>&nbsp;http://twitter.com/&nbsp;</span>
			<input style="width:60%;" type="text" name="{$fldname}" tabindex="{$vt_tab}" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
		</td>
	{/if}
{/if}