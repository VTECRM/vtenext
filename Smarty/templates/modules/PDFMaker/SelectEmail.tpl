...
<div id="roleLay2" style="z-index:12;display:block;width:350px;" class="crmvDiv">
	<div class="closebutton" onclick="hideFloatingDiv('sendpdfmail_cont')"></div>
	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerPopupTransport">
		<tr><td align=center class="small">
			<input type="button" name="{$APP.LBL_SELECT_BUTTON_LABEL}" value=" {$APP.LBL_SELECT_BUTTON_LABEL} " class="crmbutton small create" onClick="VTE.PDFMakerActions.validate_sendPDFmail('{$IDLIST}','{$FROM_MODULE}');"/>&nbsp;&nbsp;
			<input type="button" name="{$APP.LBL_CANCEL_BUTTON_LABEL}" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} " class="crmbutton small cancel" onclick="hideFloatingDiv('sendpdfmail_cont')" />
		</td></tr>
	</table>
</div>
</form>