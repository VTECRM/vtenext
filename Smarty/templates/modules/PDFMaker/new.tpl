...
<tr>        
        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
				...
				<td> 
                      ...
                      <div style="display:none;" id="company_div">
    					...
    					<tr>
    						...
    						<td class="cellText small" valign=top>
        						...
        						<input type="button" value="{$MOD.LBL_INSERT_BARCODE_TO_TEXT}" class="crmButton small create" onclick="InsertIntoTemplate('barcodeval');">&nbsp;&nbsp;<a href="modules/PDFMaker/Barcodes.php" target="_new"><img src="{'help_icon.gif'|resourcever}" border="0" align="absmiddle"></a>
      						</td>
    					</tr>
    					{************************************ Custom Functions *******************************************}
                      ...
                      <div style="display:none;" id="settings_div">
    					...
    					*}
    					...
    					<tr>
    					   ...
    					   <td class="cellText small" valign="top">
                             <select name="is_active" id="is_active" class="classname" onchange="if(this.value=='1') document.getElementById('is_default').disabled=false; else {ldelim}document.getElementById('is_default').checked=false; document.getElementById('is_default').disabled=true; {rdelim}">
                    ...
                    {*********************************************BODY DIV*************************************************}
                    <div style="diplay:block;" id="body_div2" class="cellInfo"> 
                        <textarea name="body" id="body" style="width:100%;height:700px" class=small tabindex="5">{$BODY}</textarea>
                    </div>
                    ...
                    {*********************************************Header DIV*************************************************}
                    <div style="display:none;" id="header_div2" class="cellInfo">
                    ...
                    {*********************************************Footer DIV*************************************************}
                    <div style="display:none;" id="footer_div2" class="cellInfo">
...
{ldelim}
  ...
  if (selected_module != "")
    ...
    try {ldelim}
    if (selectedTab2 == "body" && isInventorymodule(module))	//crmv@18498 //crmv@hinet
    {ldelim}
...
{ldelim}
    ...
    {ldelim}
        ...
        {/foreach}
        if (isInventorymodule(module)) //crmv@18498 //crmv@hinet
            blocks_length-=2;
    {rdelim}  
...
{ldelim}
    ...
    if (tabname == "body" && isInventorymodule(module))	//crmv@18498 //crmv@hinet
    {ldelim}
        document.getElementById('no_product_div').style.display='none';
