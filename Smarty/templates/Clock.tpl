...
<div id="wclock" style="position:fixed;" class="crmvDiv">
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		<tr style="cursor:move;" height="34">
			<td id="Handle" colspan="2" style="padding:5px" class="level3Bg"><b>{$APP.LBL_WORLD_CLOCK}</b></td>
		</tr>
	</table>
...
<div class="closebutton" onClick="fninvsh('wclock');"></div>
</div>
<script>
	// crmv@192014
	jQuery("#wclock").draggable({ldelim}
		handle: '#Handle'
	{rdelim});
	// crmv@192014e
</script>
