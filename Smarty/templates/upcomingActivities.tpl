...
<div id='todayUpcoming'>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr width="100%">
                	<!-- fix for konquer engine = safari,chrome -->
                	<td align="left"><img src="{'upcoming_left.gif'|resourcever}" align="top"></td>
			<td width="1000px"  background="{'upcomingEvents.gif'|resourcever}" style="background-repeat:repeat-x;"></td>
			<td align="right"><img src="{'upcoming_right.gif'|resourcever}" align="top"></td>
		</tr>
		<tr>
