...
class iCalendar_property {
    ...
    function get_value() {
        ...
        $replace_function = function($a) {
			return rfc2445_undo_value_formatting($a, $this->val_type);
		};
...
class iCalendar_property_method extends iCalendar_property {
    ...
    function is_valid_value($value) {
        ...
        $methods = array('PUBLISH', 'REQUEST', 'REPLY', 'ADD', 'CANCEL', 'REFRESH', 'COUNTER', 'DECLINECOUNTER');	// crmv@68357
...
class iCalendar_property_prodid extends iCalendar_property {
    ...
    function construct() {
        $this->val_default = '-//John Papaioannou/NONSGML Bennu //EN'; // crmv@fix
...
class iCalendar_property_priority extends iCalendar_property {
    ...
    var $name        = 'PRIORITY';
    var $val_type    = RFC2445_TYPE_INTEGER;	// crmv@68357 - as from specification, this is an integer!
...
class iCalendar_property_tzoffsetfrom extends iCalendar_property_tzoffsetto {
