...
} elseif($ajaxaction == "LOADLIST"){
	// crmv@168573
	require_once('modules/MyNotes/widgets/DetailViewMyNotesWidget.php');
	$parent = intval($_REQUEST['parent']);
	$widget = new MyNotes_DetailViewMyNotesWidget();
	$data = $widget->getData($parent);
