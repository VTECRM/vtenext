...
function webforms_init(){
	...
	try{
		...
		$assignedUser = CRMEntity::getInstance('Users');
		$ownerId = $assignedUser->retrieve_user_id($defaultOwner);
		$userData = webforms_getUserData(vtws_getId(VtenextWebserviceObject::fromName($adb,"Users")->getEntityId(),$ownerId),$fields,$_REQUEST);//crmv@207871
