...
//crmv@104562
} elseif($ajaxaction == "GETGANTTHOLIDAYS"){
	echo $modObj->getGanttHolidays($_REQUEST["recordid"]);
} elseif($ajaxaction == "GETGANTTJSON"){
	echo $modObj->getGanttContent($_REQUEST["recordid"],'json');
//crmv@104562e
}
?>