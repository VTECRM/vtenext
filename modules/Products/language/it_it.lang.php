...
$mod_strings = array (
  ...
  'LBL_PRODUCT_QTY_PER_UNIT' => 'Quantita`/Unita`',
  ...
  'Qty In Demand' => 'Quantita`  in richiesta',
  ...
  'LBL_MAXIMUM_LIMIT_ERROR' => 'Attenzione, il file caricato eccede i limiti massimi, riprova con uno piu` piccolo di 800000 bytes',
  'LBL_UPLOAD_ERROR' => 'Problemi nel caricamento del file. Prova di nuovo',
  'LBL_IMAGE_ERROR' => 'Il file caricato non e` di tipo immagine (.gif/.jpg/.png)',
  'LBL_INVALID_IMAGE' => 'File Invalido o File senza dati',
  'LBL_EMAIL' => 'Email',
  'Product' => 'Prodotto',
  'LBL_EDITLISTPRICE' => 'Modifica prezzo di listino',
  '--None--' => '--Nessuno--',
  'Hardware' => 'Hardware',
  'Software' => 'Software',
  ...
  'MSG_DEAR' => 'Gentile',
  'MSG_CURRENT_STOCK' => 'La disponibilita` corrente di',
  'MSG_IN_OUR_WAREHOUSE' => 'in magazzino e`',
  'MSG_PROCURE_REQUIRED_NUMBER' => 'Prego procurare il numero richiesto di unita`  in quanto la quantita` in magazzino e` minore del livello di riordino',
  'MSG_SEVERITY' => 'Importanza: Alta',
  'MSG_THANKS' => 'Grazie,',
  'LBL_SUB_PRODUCTS' => 'Sotto Prodotti',
  'Product No'=>'Numero Prodotto', //crmv@18564
