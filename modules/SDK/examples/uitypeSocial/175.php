...
//		break;
	case 'list':
		if (!empty($sdk_value))
			$value = '<a target="_blank" href="http://vkontakte.ru/'.$sdk_value.'"><img border="0" src="'.resourcever($imgdir.'bkico.png').'" align="left" alt="VKontakte" title="VKontakte" />&nbsp;'.$sdk_value.'</a>';
		else
			$value = '';
		break;
}
