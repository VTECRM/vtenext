...
//		break;
	case 'list':
		if (!empty($sdk_value))
			$value = '<a target="_blank" href="http://www.linkedin.com/in/'.$sdk_value.'"><img border="0" src="'.resourcever($imgdir.'liico.png').'" align="left" alt="Linkedin" title="Linkedin" />&nbsp;'.$sdk_value.'</a>';
		 else
		 $value = '';
		break;
}
