...
//		break;
	case 'list':
		if (!empty($sdk_value))
			$value = '<a target="_blank" href="http://www.orkut.com/Main#Profile?uid='.$sdk_value.'"><img border="0" src="'.resourcever($imgdir.'orico.png').'" align="left" alt="Orkut" title="Orkut" />&nbsp;'.$sdk_value.'</a>';
		else
			$value = '';
		break;
}
